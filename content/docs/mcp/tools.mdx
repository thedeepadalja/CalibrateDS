...
Stamps a component as implemented against the current design snapshot. Reconciles dependency statuses against `ptb.lock` before recording the stamp. Equivalent to `ptb stamp component`.
